...
# -*- coding: utf-8 -*-
#
# Pangeo Gallery build configuration file, created by
...
#
# This is also used if you do content translation via gettext Gallerys.
...
htmlhelp_basename = 'SphinxPangeoGallery'
...
latex_documents = [
    (master_doc, 'SphinxPangeoGallery.tex', 'Pangeo Gallery',
...
man_pages = [
    (master_doc, 'sphinxpangeoGallery', 'Pangeo Gallery',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SphinxPangeoGallery', 'Sphinx Pangeo Gallery Documentation',
     author, 'SphinxPangeoGallery', 'One line description of project.',
     'Miscellaneous'),
]
