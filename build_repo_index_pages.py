...
.. raw:: html
      ...
      <div class="badges">
        ...
        <a href="{{ repo.binder_url }}/v2/gh/{{ repo_data.binder_repo }}/master/?urlpath=git-pull?repo=https://github.com/{{ repo_data.path }}%26amp%3Burlpath=lab/"><img alt="Launch Binder" src="https://mybinder.org/badge_logo.svg?style=flat-square" /></a>
      </div>
